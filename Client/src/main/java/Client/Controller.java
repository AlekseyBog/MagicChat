...
public class Controller implements Initializable {
                    ...
                    while (true) {
                        ...
                        if (str.startsWith("/")) {
                            ...
                            if (str.startsWith(ServiceMessages.AUTH_OK)) {
                                ...
                                textArea.appendText(History.getLast100Msg(login));
                                History.start(login);
                                break;
                            }
    ...
    public void clickClientList(MouseEvent mouseEvent) {
        String addressee = clientList.getSelectionModel().getSelectedItem();
        textField.setText("/w " + addressee + " ");
    }
    ...
    private void createRegWindow() {
        try {
            ...
            regStage.setScene(new Scene(root, 600, 475));
